...
function watch() {
  gulp.watch(envOptions.html.watchSrc, gulp.series(layoutHTML));
  gulp.watch(envOptions.javascript.src, gulp.series(babel));
  gulp.watch(envOptions.img.src, gulp.series(imgmin));
  gulp.watch(envOptions.style.watchSrc, gulp.series(sass));
}
...
exports.build = gulp.series(clean, copyFile, imgmin, layoutHTML, sass, babel, vendorsJs);

exports.default = gulp.series(clean, copyFile, imgmin, layoutHTML, sass, babel, vendorsJs, gulp.parallel(browser, watch));
